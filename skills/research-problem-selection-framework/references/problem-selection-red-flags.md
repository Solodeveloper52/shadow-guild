# Problem Selection Red Flags

Reference guide for reviewing research problem selection framework outputs in model development, evaluation, and research operations.
