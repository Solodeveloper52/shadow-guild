---
name: research-problem-selection-framework
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the problem-selection context.
rank: a
class: ai-research
domain: ai-research
subdomain: problem-selection
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than research problem selection framework.
...
- Objective statement for research problem selection framework with scope and non-goals.
...
- Research Problem Selection Framework working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in problem-selection.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/problem-selection-framework.md
- examples/phd-problem-selection-case-study.md
- references/problem-selection-red-flags.md
