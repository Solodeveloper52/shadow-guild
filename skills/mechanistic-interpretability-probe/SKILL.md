---
name: mechanistic-interpretability-probe
description: Design technical experiments and research operations for model development, evaluation, and research operations in the interpretability context.
rank: a
class: ai-research
domain: ai-research
...
- Another skill already governs the narrower problem more directly than mechanistic interpretability probe.
...
- Objective statement for mechanistic interpretability probe with scope and non-goals.
...
- Mechanistic Interpretability Probe working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in interpretability.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/probe-design-decision-matrix.md
- examples/induction-head-circuit-investigation.md
- references/validation-and-pitfalls.md
