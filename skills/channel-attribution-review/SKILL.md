---
name: channel-attribution-review
description: Define enforceable quality gates for market positioning, campaign execution, and growth systems in the attribution context.
rank: a
class: marketing
...
Use this skill to define pass fail controls that catch bad changes before they escape for market positioning, campaign execution, and growth systems. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than channel attribution review.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently set and enforce decision gates for market positioning, campaign execution, and growth systems?

## Required Inputs

- Objective statement for channel attribution review with scope and non-goals.
...
- Channel Attribution Review working document with assumptions, options, recommendation, and review notes.
...
Objective: Clarify which failures channel attribution review must prevent.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in attribution.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/attribution-audit-template.md
- examples/budget-shift-review-example.md
- references/measurement-bias-patterns.md
