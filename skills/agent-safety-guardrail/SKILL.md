...
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the safety-alignment context.
rank: a
class: ai-research
domain: ai-research
subdomain: safety-alignment
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than agent safety guardrail.
...
- Objective statement for agent safety guardrail with scope and non-goals.
...
- Agent Safety Guardrail working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in safety-alignment.
...
- examples/autonomous-deploy-guardrail-example.md
- references/agent-escalation-patterns.md
