---
name: product-requirements-forge
description: Plan structured decisions and execution paths for planning, prioritization, and stakeholder alignment in the requirements-engineering context.
rank: a
class: product-management
domain: project-management
subdomain: requirements-engineering
maturity: pro
---

# Product Requirements Forge
...
- Another skill already governs the narrower problem more directly than product requirements forge.
...
- Objective statement for product requirements forge with scope and non-goals.
...
- Product Requirements Forge working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in requirements-engineering.
...
- examples/feature-prd-example.md
