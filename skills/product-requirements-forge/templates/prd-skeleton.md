...
Product Requirements Forge template for planning, prioritization, and stakeholder alignment. Fill every section with concrete evidence, named owners, dates, and measurable thresholds.
...
- What exact decision or output is prd skeleton meant to support?
...
- List at least three viable options for product requirements forge.
