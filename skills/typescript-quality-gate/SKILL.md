...
description: Define enforceable quality gates for language-specific implementation quality and maintainability in the typescript context.
rank: a
class: typescript
...
- Another skill already governs the narrower problem more directly than typescript quality gate.
...
- Objective statement for typescript quality gate with scope and non-goals.
...
- Typescript Quality Gate working document with assumptions, options, recommendation, and review notes.
...
Objective: Clarify which failures typescript quality gate must prevent.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in typescript.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/typescript-quality-gate.md
- examples/typescript-case-study.md
- references/typescript-pitfalls.md
