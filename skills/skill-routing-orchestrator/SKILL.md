...
description: Coordinate routing, orchestration, and efficiency decisions for cross-functional operating systems and shared practices in the routing-orchestration context.
rank: s
class: core
domain: cross-domain
subdomain: routing-orchestration
maturity: core
---
...
- Another skill already governs the narrower problem more directly than skill routing orchestrator.
...
- Objective statement for skill routing orchestrator with scope and non-goals.
...
- Skill Routing Orchestrator working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in routing-orchestration.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/skill-routing.md
- examples/routing-case-study.md
- references/routing-decision-tree.md
- references/routing-pitfalls.md
- references/routing-scorecard-template.md
