# Routing Scorecard Template

Reference guide for reviewing skill routing orchestrator outputs in cross-functional operating systems and shared practices.
...
- Optimize for reviewer comprehension; the package should be legible to cross-functional contributors and decision-makers outside the creation session.
...
- Expect evidence from shared artifacts, workflow data, handoff notes, review history whenever the recommendation claims a priority, risk, or expected impact.
...
- Require a saved artifact that can be reviewed asynchronously by cross-functional contributors and decision-makers.
...
- A required stakeholder from cross-functional contributors and decision-makers has not reviewed the decision.
