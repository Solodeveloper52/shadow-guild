---
name: positioning-message-architecture
description: Design operational blueprints for market positioning, campaign execution, and growth systems in the positioning context.
rank: a
class: marketing
...
Use this skill to turn a vague solution space into an implementable blueprint for market positioning, campaign execution, and growth systems. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than positioning message architecture.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently design the operating shape for market positioning, campaign execution, and growth systems?

## Required Inputs

- Objective statement for positioning message architecture with scope and non-goals.
...
- Positioning Message Architecture working document with assumptions, options, recommendation, and review notes.
...
Objective: Define the exact system or change surface covered by positioning message architecture in market positioning, campaign execution, and growth systems.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in positioning.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/message-architecture-framework.md
- examples/saas-positioning-pivot-case-study.md
- references/proof-validation-pitfalls.md
