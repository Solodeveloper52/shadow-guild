# Channel Role Planning Guide

Reference guide for reviewing marketing campaign orchestrator outputs in market positioning, campaign execution, and growth systems.

## What This Reference Is For

Use this guide when you need fast but defensible judgment about the quality of a routing specification before approval, rollout, or publication.
...
- Optimize for reviewer comprehension; the package should be legible to marketers, product marketers, and growth leads outside the creation session.
...
- Expect evidence from funnel metrics, audience research, campaign reports, content performance whenever the recommendation claims a priority, risk, or expected impact.
...
- Require a saved artifact that can be reviewed asynchronously by marketers, product marketers, and growth leads.
...
- What decision becomes safer or faster because this routing specification exists?
...
- A required stakeholder from marketers, product marketers, and growth leads has not reviewed the decision.
