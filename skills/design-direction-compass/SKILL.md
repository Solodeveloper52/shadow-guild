---
name: design-direction-compass
description: Plan structured decisions and execution paths for software delivery and system operation in the design-direction context.
rank: a
class: web
domain: software-engineering
subdomain: design-direction
maturity: pro
---

# Design Direction Compass
...
- Another skill already governs the narrower problem more directly than design direction compass.
...
- Objective statement for design direction compass with scope and non-goals.
...
- Design Direction Compass working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in design-direction.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/design-direction-brief.md
- examples/b2b-analytics-redirection-example.md
- references/visual-system-decision-lens.md
