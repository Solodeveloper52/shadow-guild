---
name: mlops-release-gate
description: Define enforceable quality gates for model development, evaluation, and research operations in the mlops context.
rank: a
class: ai-research
domain: ai-research
subdomain: mlops
...
Use this skill to define pass fail controls that catch bad changes before they escape for model development, evaluation, and research operations. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than mlops release gate.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently set and enforce decision gates for model development, evaluation, and research operations?

## Required Inputs

- Objective statement for mlops release gate with scope and non-goals.
...
- Mlops Release Gate working document with assumptions, options, recommendation, and review notes.
...
Objective: Clarify which failures mlops release gate must prevent.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in mlops.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/mlops-release-readiness-checklist.md
- examples/production-incident-silent-accuracy-drop.md
- references/monitoring-and-alerting-strategies.md
