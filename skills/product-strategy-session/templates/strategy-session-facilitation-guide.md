# Strategy Session Facilitation Guide

Product Strategy Session template for planning, prioritization, and stakeholder alignment. Fill every section with concrete evidence, named owners, dates, and measurable thresholds.
...
- What exact decision or output is strategy session facilitation guide meant to support?
- What is explicitly out of scope so the package does not sprawl?
- Which stakeholders from project managers, product leads, and technical owners must sign off before execution?
...
- Which evidence sources are available across roadmaps, backlogs, decision logs, delivery metrics?
...
- List at least three viable options for product strategy session.
...
- What must be true before execution begins in planning, prioritization, and stakeholder alignment?
...
- [ ] Evidence covers the relevant planning, prioritization, and stakeholder alignment signals.
