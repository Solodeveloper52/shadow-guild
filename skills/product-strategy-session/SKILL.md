...
description: Plan structured decisions and execution paths for planning, prioritization, and stakeholder alignment in the strategy context.
rank: a
...
- Another skill already governs the narrower problem more directly than product strategy session.
...
- Objective statement for product strategy session with scope and non-goals.
...
- Product Strategy Session working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in strategy.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/strategy-session-facilitation-guide.md
- examples/scaling-sales-and-product-decision-case-study.md
- references/strategic-decision-failure-modes.md
