# Dotnet Performance Investigation

Dotnet Performance Diagnostics template for software delivery and system operation. Fill every section with concrete evidence, named owners, dates, and measurable thresholds.
...
- What exact decision or output is dotnet performance investigation meant to support?
- What is explicitly out of scope so the package does not sprawl?
- Which stakeholders from engineering leads, developers, and operators must sign off before execution?
...
- Which evidence sources are available across code paths, tests, runtime metrics, incident history?
...
- List at least three viable options for dotnet performance diagnostics.
...
- What must be true before execution begins in software delivery and system operation?
...
- [ ] Evidence covers the relevant software delivery and system operation signals.
