...
description: Run evidence-backed audits and governance reviews for security posture, delivery controls, and operational resilience in the threat-modeling context.
rank: a
class: security
...
- Another skill already governs the narrower problem more directly than security threat modeler.
...
- Objective statement for security threat modeler with scope and non-goals.
...
- Security Threat Modeler working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in threat-modeling.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/threat-register-template.md
- examples/api-abuse-threat-example.md
- references/strides-and-abuse-cases.md
