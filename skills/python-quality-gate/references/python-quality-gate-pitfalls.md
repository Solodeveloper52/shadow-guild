# Python Quality Gate Pitfalls

Reference guide for reviewing python quality gate outputs in language-specific implementation quality and maintainability.

## What This Reference Is For

Use this guide when you need fast but defensible judgment about the quality of a gate specification before approval, rollout, or publication.
...
- Optimize for reviewer comprehension; the package should be legible to developers, reviewers, and maintainers outside the creation session.
...
- Expect evidence from compiler output, lint results, test evidence, profiling data whenever the recommendation claims a priority, risk, or expected impact.
...
- Require a saved artifact that can be reviewed asynchronously by developers, reviewers, and maintainers.
...
- What decision becomes safer or faster because this gate specification exists?
...
- A required stakeholder from developers, reviewers, and maintainers has not reviewed the decision.
