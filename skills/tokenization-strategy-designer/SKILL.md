---
name: tokenization-strategy-designer
description: Design technical experiments and research operations for model development, evaluation, and research operations in the tokenization context.
rank: a
class: ai-research
domain: ai-research
...
- Another skill already governs the narrower problem more directly than tokenization strategy designer.
...
- Objective statement for tokenization strategy designer with scope and non-goals.
...
- Tokenization Strategy Designer working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in tokenization.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/tokenization-strategy.md
- examples/tokenization-case-study.md
- references/tokenization-pitfalls.md
