---
name: distributed-training-topology-planner
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the distributed-training context.
rank: a
class: ai-research
domain: ai-research
...
# Distributed Training Topology Planner
...
- Another skill already governs the narrower problem more directly than distributed training topology planner.
...
- Objective statement for distributed training topology planner with scope and non-goals.
...
- Distributed Training Topology Planner working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in distributed-training.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/distributed-training-topology-scorecard.md
- examples/multinode-scaling-plan-example.md
- references/parallelism-tradeoff-guide.md
