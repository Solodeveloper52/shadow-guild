# Parallelism Tradeoff Guide

Reference guide for reviewing distributed training topology planner outputs in model development, evaluation, and research operations.
