---
name: citation-evidence-verifier
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the citation-integrity context.
rank: a
class: ai-research
domain: ai-research
subdomain: citation-integrity
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than citation evidence verifier.
...
- Objective statement for citation evidence verifier with scope and non-goals.
...
- Citation Evidence Verifier working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in citation-integrity.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/claim-evidence-ledger.md
- examples/paper-claim-verification-example.md
- references/source-strength-guide.md
