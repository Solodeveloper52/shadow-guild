...
description: Plan structured decisions and execution paths for planning, prioritization, and stakeholder alignment in the roadmapping context.
rank: a
class: project-management
domain: project-management
subdomain: roadmapping
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than pm roadmap planner.
...
- Objective statement for pm roadmap planner with scope and non-goals.
...
- Pm Roadmap Planner working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in roadmapping.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/roadmap-cadence-template.md
- examples/multi-team-quarter-plan-example.md
- references/dependency-risk-patterns.md
