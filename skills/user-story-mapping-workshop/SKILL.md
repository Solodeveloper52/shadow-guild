...
description: Facilitate structured sessions and reusable playbooks for planning, prioritization, and stakeholder alignment in the delivery-planning context.
rank: a
...
- Another skill already governs the narrower problem more directly than user story mapping workshop.
...
- Objective statement for user story mapping workshop with scope and non-goals.
...
- User Story Mapping Workshop working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in delivery-planning.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/user-story-mapping.md
- examples/story-mapping-case-study.md
- references/story-mapping-pitfalls.md
