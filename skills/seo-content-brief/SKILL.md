...
description: Produce high-clarity narrative and communication assets for market positioning, campaign execution, and growth systems in the seo-content context.
rank: a
class: marketing
domain: marketing-growth
subdomain: seo-content
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than seo content brief.
...
- Objective statement for seo content brief with scope and non-goals.
...
- Seo Content Brief working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in seo-content.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/seo-content-brief.md
- examples/seo-traffic-increase-case-study.md
- references/seo-brief-pitfalls.md
