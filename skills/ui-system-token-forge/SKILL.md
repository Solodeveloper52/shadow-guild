---
name: ui-system-token-forge
description: Plan structured decisions and execution paths for software delivery and system operation in the design-system context.
rank: a
class: web
...
- Another skill already governs the narrower problem more directly than ui system token forge.
...
- Objective statement for ui system token forge with scope and non-goals.
...
- Ui System Token Forge working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in design-system.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/ui-tokens-framework.md
- examples/ui-tokens-case-study.md
- references/ui-token-pitfalls.md
