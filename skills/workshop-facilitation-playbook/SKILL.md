---
name: workshop-facilitation-playbook
description: Facilitate structured sessions and reusable playbooks for planning, prioritization, and stakeholder alignment in the facilitation context.
rank: a
...
Use this skill to run a high-signal collaborative session that ends with decisions and owned follow-up for planning, prioritization, and stakeholder alignment. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than workshop facilitation playbook.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently facilitate a structured working session for planning, prioritization, and stakeholder alignment?

## Required Inputs

- Objective statement for workshop facilitation playbook with scope and non-goals.
...
- Workshop Facilitation Playbook working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in facilitation.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/workshop-facilitation.md
- examples/workshop-facilitation-case-study.md
- references/workshop-facilitation-pitfalls.md
