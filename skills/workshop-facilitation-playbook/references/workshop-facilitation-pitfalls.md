# Workshop Facilitation Pitfalls

Reference guide for reviewing workshop facilitation playbook outputs in planning, prioritization, and stakeholder alignment.

## What This Reference Is For

Use this guide when you need fast but defensible judgment about the quality of a facilitation packet before approval, rollout, or publication.
...
- Optimize for reviewer comprehension; the package should be legible to project managers, product leads, and technical owners outside the creation session.
...
- Expect evidence from roadmaps, backlogs, decision logs, delivery metrics whenever the recommendation claims a priority, risk, or expected impact.
...
- Require a saved artifact that can be reviewed asynchronously by project managers, product leads, and technical owners.
...
- What decision becomes safer or faster because this facilitation packet exists?
...
- A required stakeholder from project managers, product leads, and technical owners has not reviewed the decision.
