...
description: Plan structured decisions and execution paths for market positioning, campaign execution, and growth systems in the growth-operations context.
rank: a
class: marketing
domain: marketing-growth
subdomain: growth-operations
maturity: pro
---

# Growth Experiment Backlog

Use this skill to shape ambiguous work into a staged plan with explicit tradeoffs for market positioning, campaign execution, and growth systems. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than growth experiment backlog.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently build a decision-ready plan for market positioning, campaign execution, and growth systems?

## Required Inputs

- Objective statement for growth experiment backlog with scope and non-goals.
...
- Growth Experiment Backlog working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in growth-operations.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/growth-experiment-backlog.md
- examples/onboarding-conversion-experiment-example.md
- references/experiment-prioritization-rules.md
