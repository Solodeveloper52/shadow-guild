...
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the ablation-analysis context.
rank: a
class: ai-research
domain: ai-research
subdomain: ablation-analysis
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than ablation study planner.
...
- Objective statement for ablation study planner with scope and non-goals.
...
- Ablation Study Planner working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in ablation-analysis.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/ablation-matrix-template.md
- examples/component-isolation-example.md
- references/confounding-risk-guide.md
