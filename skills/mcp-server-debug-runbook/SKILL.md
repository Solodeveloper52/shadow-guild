---
name: mcp-server-debug-runbook
description: Facilitate structured sessions and reusable playbooks for software delivery and system operation in the mcp-debugging context.
rank: a
class: backend
domain: software-engineering
subdomain: mcp-debugging
maturity: pro
---

# Mcp Server Debug Runbook
...
- Another skill already governs the narrower problem more directly than mcp server debug runbook.
...
- Objective statement for mcp server debug runbook with scope and non-goals.
...
- Mcp Server Debug Runbook working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in mcp-debugging.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/mcp-failure-triage-matrix.md
- examples/tool-execution-timeout-case.md
- references/mcp-protocol-trace-checklist.md
