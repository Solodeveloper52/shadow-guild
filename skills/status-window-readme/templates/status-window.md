...
Status Window Readme template for cross-functional operating systems and shared practices. Fill every section with concrete evidence, named owners, dates, and measurable thresholds.
...
- What exact decision or output is status window meant to support?
...
- List at least three viable options for status window readme.
