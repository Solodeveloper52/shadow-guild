---
name: status-window-readme
description: Produce high-clarity narrative and communication assets for cross-functional operating systems and shared practices in the documentation context.
rank: a
class: authoring
domain: cross-domain
...
# Status Window Readme

Use this skill to shape complex context into a communication asset that changes decisions or behavior for cross-functional operating systems and shared practices. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than status window readme.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently craft a clear narrative asset for cross-functional operating systems and shared practices?

## Required Inputs

- Objective statement for status window readme with scope and non-goals.
...
- Status Window Readme working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in documentation.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/status-window.md
- examples/status-window-case-study.md
- references/status-window-pitfalls.md
