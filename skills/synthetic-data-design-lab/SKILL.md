---
name: synthetic-data-design-lab
description: Design technical experiments and research operations for model development, evaluation, and research operations in the synthetic-data context.
rank: a
class: ai-research
domain: ai-research
...
- Another skill already governs the narrower problem more directly than synthetic data design lab.
...
- Objective statement for synthetic data design lab with scope and non-goals.
...
- Synthetic Data Design Lab working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in synthetic-data.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/synthetic-data-framework.md
- examples/synthetic-data-case-study.md
- references/synthetic-data-pitfalls.md
