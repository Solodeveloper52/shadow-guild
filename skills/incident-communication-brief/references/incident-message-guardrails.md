# Incident Message Guardrails

Reference guide for reviewing incident communication brief outputs in governance, risk, controls, and operational accountability.
...
- Optimize for reviewer comprehension; the package should be legible to governance owners, team leads, and auditors outside the creation session.
...
- Expect evidence from access records, policy documents, risk logs, audit trails whenever the recommendation claims a priority, risk, or expected impact.
...
- Require a saved artifact that can be reviewed asynchronously by governance owners, team leads, and auditors.
...
- A required stakeholder from governance owners, team leads, and auditors has not reviewed the decision.
