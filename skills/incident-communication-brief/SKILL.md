---
name: incident-communication-brief
description: Produce high-clarity narrative and communication assets for governance, risk, controls, and operational accountability in the incident-communication context.
rank: a
class: operations
domain: operations-governance
subdomain: incident-communication
maturity: pro
---

# Incident Communication Brief

Use this skill to shape complex context into a communication asset that changes decisions or behavior for governance, risk, controls, and operational accountability. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than incident communication brief.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently craft a clear narrative asset for governance, risk, controls, and operational accountability?

## Required Inputs

- Objective statement for incident communication brief with scope and non-goals.
...
- Incident Communication Brief working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in incident-communication.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/incident-update-brief.md
- examples/customer-impact-update-example.md
- references/incident-message-guardrails.md
