...
description: Facilitate structured sessions and reusable playbooks for model development, evaluation, and research operations in the prompt-engineering context.
rank: a
class: ai-research
domain: ai-research
...
Use this skill to run a high-signal collaborative session that ends with decisions and owned follow-up for model development, evaluation, and research operations. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than prompt engineering playbook.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently facilitate a structured working session for model development, evaluation, and research operations?

## Required Inputs

- Objective statement for prompt engineering playbook with scope and non-goals.
...
- Prompt Engineering Playbook working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in prompt-engineering.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/prompt-design-template-and-patterns.md
- examples/customer-support-automation-case-study.md
- references/prompt-failure-modes-and-patterns.md
