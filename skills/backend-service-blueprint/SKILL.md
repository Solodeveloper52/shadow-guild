---
name: backend-service-blueprint
description: Design operational blueprints for software delivery and system operation in the backend-architecture context.
rank: a
class: backend
domain: software-engineering
subdomain: backend-architecture
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than backend service blueprint.
...
- Objective statement for backend service blueprint with scope and non-goals.
...
- Backend Service Blueprint working document with assumptions, options, recommendation, and review notes.
...
Objective: Define the exact system or change surface covered by backend service blueprint in software delivery and system operation.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in backend-architecture.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/service-boundary-template.md
- examples/event-driven-service-example.md
- references/api-and-slo-checklist.md
