...
description: Design operational blueprints for software delivery and system operation in the mcp-architecture context.
rank: a
class: backend
...
- Another skill already governs the narrower problem more directly than mcp server architecture.
...
- Objective statement for mcp server architecture with scope and non-goals.
...
- Mcp Server Architecture working document with assumptions, options, recommendation, and review notes.
...
Objective: Define the exact system or change surface covered by mcp server architecture in software delivery and system operation.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in mcp-architecture.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/mcp-server-architecture-brief.md
- examples/multi-tenant-mcp-server-example.md
- references/tool-contract-safety-checklist.md
