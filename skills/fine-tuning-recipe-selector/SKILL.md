---
name: fine-tuning-recipe-selector
description: Design technical experiments and research operations for model development, evaluation, and research operations in the fine-tuning context.
rank: a
class: ai-research
domain: ai-research
...
- Another skill already governs the narrower problem more directly than fine tuning recipe selector.
...
- Objective statement for fine tuning recipe selector with scope and non-goals.
...
- Fine Tuning Recipe Selector working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in fine-tuning.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/fine-tuning-decision-matrix.md
- examples/adapter-vs-full-tune-example.md
- references/fine-tuning-readiness-checklist.md
