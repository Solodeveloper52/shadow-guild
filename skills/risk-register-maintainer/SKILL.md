...
description: Run evidence-backed audits and governance reviews for planning, prioritization, and stakeholder alignment in the risk-management context.
rank: a
...
Use this skill to inspect the current state, surface real risk, and drive remediation with ownership for planning, prioritization, and stakeholder alignment. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than risk register maintainer.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently audit the current state for planning, prioritization, and stakeholder alignment?

## Required Inputs

- Objective statement for risk register maintainer with scope and non-goals.
...
- Risk Register Maintainer working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in risk-management.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/risk-register-framework.md
- examples/fintech-risk-register-case-study.md
- references/risk-register-pitfalls.md
