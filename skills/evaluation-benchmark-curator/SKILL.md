---
name: evaluation-benchmark-curator
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the benchmark-curation context.
rank: a
class: ai-research
domain: ai-research
subdomain: benchmark-curation
maturity: pro
---

# Evaluation Benchmark Curator
...
- Another skill already governs the narrower problem more directly than evaluation benchmark curator.
...
- Objective statement for evaluation benchmark curator with scope and non-goals.
...
- Evaluation Benchmark Curator working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in benchmark-curation.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/benchmark-coverage-matrix.md
- examples/safety-capability-benchmark-portfolio.md
- references/benchmark-refresh-governance.md
