...
description: Design operational blueprints for software delivery and system operation in the architecture-review context.
rank: a
class: architecture
...
- Another skill already governs the narrower problem more directly than software architecture review.
...
- Objective statement for software architecture review with scope and non-goals.
...
- Software Architecture Review working document with assumptions, options, recommendation, and review notes.
...
Objective: Define the exact system or change surface covered by software architecture review in software delivery and system operation.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in architecture-review.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/architecture-review-framework.md
- examples/architecture-review-case-study.md
- references/architecture-review-pitfalls.md
