...
description: Plan structured decisions and execution paths for governance, risk, controls, and operational accountability in the compliance-evidence context.
rank: a
class: security
domain: operations-governance
subdomain: compliance-evidence
maturity: pro
---

# Compliance Evidence Packager

Use this skill to shape ambiguous work into a staged plan with explicit tradeoffs for governance, risk, controls, and operational accountability. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than compliance evidence packager.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently build a decision-ready plan for governance, risk, controls, and operational accountability?

## Required Inputs

- Objective statement for compliance evidence packager with scope and non-goals.
...
- Compliance Evidence Packager working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in compliance-evidence.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/control-evidence-matrix.md
- examples/soc2-audit-pack-example.md
- references/evidence-freshness-checklist.md
