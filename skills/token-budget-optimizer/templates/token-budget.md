...
Token Budget Optimizer template for cross-functional operating systems and shared practices. Fill every section with concrete evidence, named owners, dates, and measurable thresholds.
...
- What exact decision or output is token budget meant to support?
...
- List at least three viable options for token budget optimizer.
