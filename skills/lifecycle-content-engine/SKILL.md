---
name: lifecycle-content-engine
description: Produce high-clarity narrative and communication assets for market positioning, campaign execution, and growth systems in the lifecycle-marketing context.
rank: a
class: marketing
domain: marketing-growth
subdomain: lifecycle-marketing
maturity: pro
---

# Lifecycle Content Engine

Use this skill to shape complex context into a communication asset that changes decisions or behavior for market positioning, campaign execution, and growth systems. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.
...
- Another skill already governs the narrower problem more directly than lifecycle content engine.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently craft a clear narrative asset for market positioning, campaign execution, and growth systems?

## Required Inputs

- Objective statement for lifecycle content engine with scope and non-goals.
...
- Lifecycle Content Engine working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in lifecycle-marketing.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/lifecycle-content-operating-model.md
- examples/saas-lifecycle-content-example.md
- references/lifecycle-stage-message-rules.md
