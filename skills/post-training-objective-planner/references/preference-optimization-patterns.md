# Preference Optimization Patterns

Reference guide for reviewing post training objective planner outputs in model development, evaluation, and research operations.
