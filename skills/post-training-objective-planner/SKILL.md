---
name: post-training-objective-planner
description: Plan structured decisions and execution paths for model development, evaluation, and research operations in the post-training context.
rank: a
class: ai-research
domain: ai-research
...
# Post Training Objective Planner
...
- Another skill already governs the narrower problem more directly than post training objective planner.
...
- Objective statement for post training objective planner with scope and non-goals.
...
- Post Training Objective Planner working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in post-training.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/objective-hierarchy-template.md
- examples/customer-support-fine-tuning-case-study.md
- references/preference-optimization-patterns.md
