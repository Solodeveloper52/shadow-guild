---
name: user-story-splitting-strategy
description: Plan structured decisions and execution paths for planning, prioritization, and stakeholder alignment in the story-splitting context.
rank: a
class: project-management
domain: project-management
subdomain: story-splitting
maturity: pro
---

# User Story Splitting Strategy

Use this skill to shape ambiguous work into a staged plan with explicit tradeoffs for planning, prioritization, and stakeholder alignment. The method assumes you need evidence-backed decisions, reusable artifacts, and a review trail that survives beyond the current session.

## Use This Skill When

- You are preparing to build a decision-ready plan and need a repeatable operating method instead of ad hoc judgment.
- The work affects project managers, product leads, and technical owners and the decision needs explicit tradeoffs, evidence, and ownership.
...
- Another skill already governs the narrower problem more directly than user story splitting strategy.

## Trigger Question

What evidence, constraints, and decision criteria do we need before we can confidently build a decision-ready plan for planning, prioritization, and stakeholder alignment?

## Required Inputs

- Objective statement for user story splitting strategy with scope and non-goals.
- Current state evidence covering roadmaps, backlogs, decision logs, delivery metrics.
- Named stakeholders: project managers, product leads, and technical owners.
...
- User Story Splitting Strategy working document with assumptions, options, recommendation, and review notes.
...
- Prefer options that reduce ambiguity for project managers, product leads, and technical owners without hiding material tradeoffs.
...
- The output references concrete evidence from roadmaps, backlogs, decision logs, delivery metrics rather than generic advice.
...
- The team optimizes for speed and skips the tradeoff analysis needed by project managers, product leads, and technical owners.
...
- Planning cycle time from request to approved artifact.
...
- Pull in project managers, product leads, and technical owners early enough to validate constraints before solution shaping begins.
- Keep open questions separate from blocked items so reviewers can distinguish uncertainty from missing work.
- Use short review loops; long silent drafting phases tend to hide assumption drift in story-splitting.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/story-splitting-strategy.md
- examples/story-splitting-case-study.md
- references/story-splitting-pitfalls.md
