...
description: Plan structured decisions and execution paths for planning, prioritization, and stakeholder alignment in the problem-framing context.
rank: a
class: product-management
domain: project-management
subdomain: problem-framing
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than problem framing canvas.
...
- Objective statement for problem framing canvas with scope and non-goals.
...
- Problem Framing Canvas working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in problem-framing.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/problem-canvas-framework.md
- examples/marketplace-onboarding-problem-reframe.md
- references/problem-definition-anti-patterns.md
