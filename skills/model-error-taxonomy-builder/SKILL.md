---
name: model-error-taxonomy-builder
description: Design technical experiments and research operations for model development, evaluation, and research operations in the error-analysis context.
rank: a
class: ai-research
domain: ai-research
...
- Another skill already governs the narrower problem more directly than model error taxonomy builder.
...
- Objective statement for model error taxonomy builder with scope and non-goals.
...
- Model Error Taxonomy Builder working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in error-analysis.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/error-taxonomy-methodology.md
- examples/customer-email-taxonomy-case-study.md
- references/root-cause-analysis-patterns.md
