...
description: Design technical experiments and research operations for model development, evaluation, and research operations in the literature-review context.
rank: a
class: ai-research
domain: ai-research
subdomain: literature-review
maturity: pro
---
...
- Another skill already governs the narrower problem more directly than research literature synthesis.
...
- Objective statement for research literature synthesis with scope and non-goals.
...
- Research Literature Synthesis working document with assumptions, options, recommendation, and review notes.
...
- Use short review loops; long silent drafting phases tend to hide assumption drift in literature-review.
- When handing off, package the recommendation, evidence links, and next decision checkpoint together.

## Companion Assets

- templates/literature-synthesis-framework.md
- examples/icl-literature-synthesis-case-study.md
- references/synthesis-pitfalls.md
